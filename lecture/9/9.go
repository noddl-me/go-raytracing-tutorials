...
func main() {
	...
	materialCenter := utils.NewLambertian(utils.NewVector3(0.7, 0.3, 0.3))
	materialLeft := utils.NewMetal(utils.NewVector3(0.8, 0.8, 0.8), 0.3)
	materialRight := utils.NewMetal(utils.NewVector3(0.8, 0.6, 0.2), 1.0)
